...
<body class="min-h-screen">
        ...
        <div class="p-6">
            ...
            <div class="upload-container card rounded-2xl p-6 mb-6">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Upload Excel file or paste multiple tracking numbers</p>
                </div>
    ...
    <script>
        ...
        function switchTab(tab) {
            ...
            // Update tab buttons
            document.getElementById('excelTab').className = tab === 'excel'
            ...
            // Show/hide sections
            document.getElementById('excelSection').classList.toggle('hidden', tab !== 'excel');
        ...
        function handleDrop(event) {
            ...
            if (files.length > 0 && (files[0].name.endsWith('.xlsx') || files[0].name.endsWith('.xls'))) {
                ...
                showNotification('Please drop a valid Excel file (.xlsx or .xls).', 'error');
            }
        }
            ...
            trackingData.forEach((item, index) => {
                ...
                if (item.status === 'success' && item.data.data) {
                    ...
                    item.data.data.forEach(event => {
                        ...
                        if ((process.includes('deliver') || process.includes('complete') || process.includes('success') || process.includes('ready for self-collect')) && eventDate) {
